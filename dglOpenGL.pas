...
// detecting MacOS X
 ...
 {$IF DEFINED(DARWIN) and ( not DEFINED(iPHONESIM) ) and ( not DEFINED(CPUARM) )}
  {$DEFINE DGL_MACOSX}
...
function dglGetProcAddress(ProcName: PAnsiChar; LibHandle: Pointer = nil {$IF DEFINED(DGL_LINUX) or DEFINED(DGL_MACOSX)}; ForceDLSym: Boolean = False{$IFEND}): Pointer;
...
function dlopen(Name: PAnsiChar; Flags: LongInt): Pointer; cdecl; external name 'dlopen';
function dlclose(Lib: Pointer): LongInt; cdecl; external name 'dlclose';

function dlsym(Lib: Pointer; Name: PAnsiChar): Pointer; cdecl; external name 'dlsym';
{$ENDIF}
