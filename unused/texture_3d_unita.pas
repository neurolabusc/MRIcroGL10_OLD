...
(*  if  (lTex.NIFTIHdr.cal_min < lTex.NIFTIHdr.cal_max) and InRange(lTex.WindowScaledMin,lTex.WindowScaledMax,lTex.NIFTIHdr.cal_min,lTex.NIFTIHdr.cal_max) then begin
