...
//procedure Enter2Dz (lScrnWid, lScrnHt: integer);
procedure Enter2Dx;
procedure Enter2Do(zoomOffsetX, zoomOffsetY: integer);
implementation
uses raycastglsl;
//uses SysUtils,classes, raycastglsl, mainunit;

procedure Enter2Dv (lScrnWid, lScrnHt: integer);
begin
  glMatrixMode(GL_PROJECTION);
  glLoadIdentity;
  glOrtho(0, lScrnWid, 0, lScrnHt,-1,1);//<- same effect as previous line
...
procedure Enter2Dx;
begin
  Enter2Dv (gRayCast.WINDOW_WIDTH,gRayCast.WINDOW_HEIGHT);
end;
